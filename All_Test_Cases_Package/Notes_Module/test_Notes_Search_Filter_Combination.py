...
class Test_Notes_Search_Filter_Combination(Base_Class):
    ...
    def test_TC_NSFC_01(self):
        ...
        if Notes_search_filter_combination_pom(self.logger).notes_with_no_filter_combination():
            assert True
        else:
    ...
    def test_TC_NSFC_02(self):
        ...
        if Notes_search_filter_combination_pom(self.logger).notes_with_sort_by_Case_Subject_filter_combination():
            assert True
        else:
    ...
    def test_TC_NSFC_03(self):
        ...
        if Notes_search_filter_combination_pom(self.logger).notes_with_sort_by_location_store_filter_combination():
            assert True
        else:
    ...
    def test_TC_NSFC_04(self):
        ...
        if Notes_search_filter_combination_pom(self.logger). \
    ...
    def test_TC_NSFC_05(self):
        ...
        if Notes_search_filter_combination_pom(self.logger).notes_with_Case_Subject_filter_combination():
            assert True
        else:
    ...
    def test_TC_NSFC_06(self):
        ...
        if Notes_search_filter_combination_pom(self.logger).notes_with_Case_Subject_and_Sort_by_Case_Subject_filter_combination():
            assert True
        else:
